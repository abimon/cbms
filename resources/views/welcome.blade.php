...
<body>
    <div class="py-12">
        <div class="auth-container" style="min-height: 100vh; background: linear-gradient(135deg, #dc3545 0%, #b02a37 30%, #212529 100%);">
            <div class="text-center text-white">
                <i class="bi bi-droplet-fill display-1 mb-4"></i>
                <h1 class="display-4 fw-bold mb-3">Centralized Blood Management System</h1>
                <p class="lead mb-4">Save lives through efficient blood inventory management</p>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-4">
                            <div class="bg-white bg-opacity-10 rounded p-4">
                                ...
                                <p class="small mb-0">Track and manage blood stock across all banks</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="bg-white bg-opacity-10 rounded p-4">
                                ...
                                <p class="small mb-0">Process transfusion requests from hospitals</p>
                            </div>
                        </div>
                        <div class="col-md-4 mb-4">
                            <div class="bg-white bg-opacity-10 rounded p-4">
                                ...
                                <h5>Blood Banks</h5>
                                <p class="small mb-0">Manage multiple blood bank locations</p>
                            </div>
                        </div>
                    </div>
                </div>
